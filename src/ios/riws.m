...
-(void)loadPolygons{
    ...
    coordinates = @"23.91927781986096,37.92055823300723,0 23.91983863807643,37.92063705417456,0 23.91980707140927,37.92072308318052,0 23.91926108055774,37.92065582780219,0 23.91927781986096,37.92055823300723,0 ";
    polygonGuid = @"76";
    polygonName = @"HOLD SHORT 03L AT A1";
    [[RIWS sharedManager]addPolygons:coordinates forPolygonGUID:polygonGuid PolygonName:polygonName isforceReplace:canForceReplace];
    
    
    coordinates = @"23.91995913642101,37.92127816999346,0 23.92004042454992,37.92121713413641,0 23.92036662264275,37.92155212325996,0 23.92027466359604,37.92161207097271,0 23.91995913642101,37.92127816999346,0 ";
    polygonGuid = @"77";
    ...
    coordinates = @"23.92794513032486,37.92981693877488,0 23.92793282296175,37.9297242533947,0 23.92851722131348,37.92967248713891,0 23.92851349196379,37.92976015027,0 23.92794513032486,37.92981693877488,0 ";
    polygonGuid = @"80";
    polygonName = @"HOLD SHORT 13L - 21R AT A5";
    [[RIWS sharedManager]addPolygons:coordinates forPolygonGUID:polygonGuid PolygonName:polygonName isforceReplace:canForceReplace];
    
    
    coordinates = @"23.9316035153978,37.93300543910296,0 23.93115187123525,37.93304660792981,0 23.93079880995908,37.93266919520917,0 23.93082636294473,37.93264754863994,0 23.93084616964745,37.93260204676049,0 23.93085837135041,37.932567563807,0 23.93120128874148,37.93294686495682,0 23.93159547705876,37.93291402789896,0 23.9316035153978,37.93300543910296,0 ";
    polygonGuid = @"81";
    polygonName = @"HOLD SHORT 13L - 21R AT A6";
    [[RIWS sharedManager]addPolygons:coordinates forPolygonGUID:polygonGuid PolygonName:polygonName isforceReplace:canForceReplace];
    
    
    coordinates = @"23.93461149965064,37.93668627431752,0 23.93425402126189,37.9363093499642,0 23.93444476375005,37.93597199304894,0 23.93455206495138,37.93599813271135,0 23.93438262881014,37.93630233790063,0 23.93473416705697,37.9366642134849,0 23.93469838461115,37.93666255534237,0 23.93467102174879,37.93666338685894,0 23.93462682164929,37.93668081991347,0 23.93461149965064,37.93668627431752,0 ";
    polygonGuid = @"82";
    polygonName = @"HOLD SHORT 13L - 21R AT A9";
    [[RIWS sharedManager]addPolygons:coordinates forPolygonGUID:polygonGuid PolygonName:polygonName isforceReplace:canForceReplace];
    
    
    coordinates = @"23.93750913549918,37.93922553227481,0 23.93754824636533,37.93923434190745,0 23.9375966684922,37.93923874438688,0 23.93762620099995,37.93924090406361,0 23.93738676474285,37.93968163762342,0 23.93728538823567,37.93964866690095,0 23.93750913549918,37.93922553227481,0 ";
    polygonGuid = @"83";
    polygonName = @"HOLD SHORT 13L - 21R AT A10";
    [[RIWS sharedManager]addPolygons:coordinates forPolygonGUID:polygonGuid PolygonName:polygonName isforceReplace:canForceReplace];
    
    
    coordinates = @"23.94059531849486,37.94246919227299,0 23.94063295241634,37.94247749826491,0 23.94068714423263,37.94248342812686,0 23.94071273434033,37.94248342542672,0 23.9404689513931,37.94293811942696,0 23.94036206789686,37.94289895523422,0 23.94059531849486,37.94246919227299,0 ";
    polygonGuid = @"84";
    polygonName = @"HOLD SHORT 13L - 21R AT A11";
    [[RIWS sharedManager]addPolygons:coordinates forPolygonGUID:polygonGuid PolygonName:polygonName isforceReplace:canForceReplace];
    
    
    coordinates = @"23.94648956322156,37.94932719301956,0 23.94672660627585,37.94888867950633,0 23.94683665646383,37.94891665760635,0 23.94659923276429,37.94936111342461,0 23.94648956322156,37.94932719301956,0 ";
    polygonGuid = @"85";
    polygonName = @"HOLD SHORT 13L - 21R AT A14";
    [[RIWS sharedManager]addPolygons:coordinates forPolygonGUID:polygonGuid PolygonName:polygonName isforceReplace:canForceReplace];
    
    
    coordinates = @"23.94483037604825,37.94744118893619,0 23.94492537606718,37.94738822924303,0 23.94524849403384,37.94771984772579,0 23.9451813710396,37.94780277361213,0 23.94483037604825,37.94744118893619,0 ";
    polygonGuid = @"86";
    ...
    coordinates = @"23.9696577149204,37.95288870344232,0 23.96934518474914,37.95254678087028,0 23.96943470102435,37.95249302302649,0 23.96974893433098,37.95283600560133,0 23.9696577149204,37.95288870344232,0 ";
    polygonGuid = @"88";
    polygonName = @"HOLD SHORT 21L AT D12";
    [[RIWS sharedManager]addPolygons:coordinates forPolygonGUID:polygonGuid PolygonName:polygonName isforceReplace:canForceReplace];
    
    
    coordinates = @"23.97046599250114,37.95344263765548,0 23.97044901537534,37.95353202414215,0 23.96987048108227,37.95347269602465,0 23.96990721754482,37.9533860745579,0 23.97046599250114,37.95344263765548,0 ";
    polygonGuid = @"89";
    polygonName = @"HOLD SHORT 21L AT D13";
    [[RIWS sharedManager]addPolygons:coordinates forPolygonGUID:polygonGuid PolygonName:polygonName isforceReplace:canForceReplace];
    
    
    coordinates = @"23.96348263308257,37.94607096413969,0 23.9634983334175,37.94616091636581,0 23.96290549643672,37.94620760380597,0 23.96291035067059,37.94611770731954,0 23.96348263308257,37.94607096413969,0 ";
    polygonGuid = @"90";
    ...
    coordinates = @"23.94931146538906,37.93117020912923,0 23.94908412044038,37.931612532021,0 23.94904031629176,37.93159726246422,0 23.94898907792342,37.93160397668149,0 23.94895455169898,37.93160710025607,0 23.94920489129135,37.93113593806854,0 23.94931146538906,37.93117020912923,0 ";
    polygonGuid = @"96";
    polygonName = @"HOLD SHORT 21L-13R AT D4";
    [[RIWS sharedManager]addPolygons:coordinates forPolygonGUID:polygonGuid PolygonName:polygonName isforceReplace:canForceReplace];
    
    
    coordinates = @"23.94367664496096,37.92537950752923,0 23.94358792416975,37.92543386148166,0 23.94326322898393,37.92509295827881,0 23.94335319420397,37.92503629172063,0 23.94367664496096,37.92537950752923,0 ";
    polygonGuid = @"97";
    polygonName = @"HOLD SHORT 21L-13R AT D2";
    [[RIWS sharedManager]addPolygons:coordinates forPolygonGUID:polygonGuid PolygonName:polygonName isforceReplace:canForceReplace];
    
    
    coordinates = @"23.9423785514705,37.92435410557685,0 23.94226490484424,37.92435663150629,0 23.94228651665691,37.92390812936853,0 23.9423960415381,37.92391281634745,0 23.9423785514705,37.92435410557685,0 ";
    polygonGuid = @"98";
